    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                // Une fois terminé, démarrer l'activité suivante sur l'UI thread
                runOnUiThread(new Runnable() {
                    public void run() {
                        Log.d("PremierActivity", "Démarrage de l'activité Connection_User");
                        Intent i = new Intent(Premier.this, Accueil.class);
                        startActivity(i);
                        finish();
                    }
                });
